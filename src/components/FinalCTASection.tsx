...
const FinalCTASection = () => {
  return (
    <section className="py-20 md:py-28 relative z-10" aria-label="Comece a usar Lovable grátis agora">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-6">
            Comece a Usar Lovable de Graça Agora
          </h2>
          <p className="text-muted-foreground mb-4">
            Cada dia sem o LovaZero é um dia sem Lovable grátis, sem hospedagem e com projetos parados.
          </p>
          <p className="text-muted-foreground mb-8">
            Garanta Lovable unlimited pra sempre. Essa oferta pode sair do ar a qualquer momento.
          </p>
